...
# Password Generator program requirements:
# program requires 2 integers (whole numbers without decimal points), length of the password and number of passwords
# integer 1 minimum is 6 of 350 and integer 2 min is 1 and max is 10
# step 2 create a basic program
# step 3 test your program with all possible inputs (hardcoded):
# correct input (integers within the range), incorrect input: letters, negative numbers
